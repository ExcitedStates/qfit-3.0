...
def parse_args():
    ...
    p.add_argument("holo_structure", type=str, help="PDB-file containing structure.")
    p.add_argument(
        "apo_structure", type=str, help="PDB-file containing structure."
    )  # this should be a superposed PDB files
    ...
    p.add_argument(
        ...
        default="5.0",
        metavar="<float>",
        help="angstrom distance from ligand",
    )
...
def main():
    ...
    rmsd_alpha_carbon(
        holo_receptor, apo_receptor, args.holo_pdb_name, args.apo_pdb_name
    )
