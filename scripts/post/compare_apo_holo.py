...
def parse_args():
    ...
    p.add_argument("chain", type=str, help="Chain in structure, e.g. A.")
    p.add_argument("structure2", type=str, help="PDB-file containing structure2.")
    p.add_argument(
        "res_list",
        type=str,
    ...
    with open(args.res_list) as f:
        for line in f.readlines():
            ...
            print(
                ...
                altlocs,
                altlocs2,
                structure_resi.resn[0],
                structure_resi2.resn[0],
                structure_resi.chain[0],
                structure_resi.resi[0],
                structure_resi2.chain[0],
                structure_resi2.resi[0],
            )
