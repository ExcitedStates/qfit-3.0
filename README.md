...
`qfit_protein /path/to/3K0N_omit_map.mtz -l 2FOFCWT,PH2FOFCWT /path/to/3K0N.pdb`

After *multiconformer_model2.pdb* has been generated, refine this model using:

`qfit_final_refine_xray.sh /path/to/3K0N_input.mtz multiconformer_model2.pdb`
...
`qfit_residue /path/to/3K0N_omit_map.mtz -l 2FOFCWT,PH2FOFCWT /path/to/3K0N.pdb A,113`
...
`qfit_protein [COMPOSITE_OMIT_MAP_FILE] [PDB_FILE] -r [RESOLUTION]`

Using the example 3K0N:

`qfit_residue /path/to/3K0N_omit_map.ccp4 /path/to/3K0N.pdb -r 1.39`

For Cyro-EM ccp4 maps, you can use the example from the Apoferritin Chain A (PDB:7A4M)

`qfit_protein /path/to/apoF_chainA_omit_map.ccp4 /path/to/apoF_chainA.pdb -r 1.22`

After *multiconformer_model2.pdb* has been generated, refine this model using:
`qfit_final_refine_cryoem.sh /path/to/apoF_chainA_input.ccp4 apoF_chainA.pdb multiconformer_model2.pdb`
...
`qfit_residue /path/to/3K0N_omit_map.mtz -l 2FOFCWT,PH2FOFCWT /path/to/3K0N.pdb A,113 --no-backbone --no-sample-angle -s 20 -rn 45 --no-threshold-selection`
...
`qfit_protein /path/to/3K0N_omit_map.mtz -l 2FOFCWT,PH2FOFCWT /path/to/3K0N.pdb --no-backbone --no-sample-angle -s 20 -rn 45 --no-threshold-selection`
...
`qfit_protein /path/to/3K0N_omit_map.mtz -l 2FOFCWT,PH2FOFCWT /path/to/3K0N.pdb -p 30`
...
`qfit_segment /path/to/3K0N_omit_map.mtz -l 2FOFCWT,PH2FOFCWT /path/to/multiconformer_model.pdb --no-segment-threshold-selection -f 3`
