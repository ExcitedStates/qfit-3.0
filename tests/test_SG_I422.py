...
class TestQFitProtein:
    def mock_main(self):
        # Prepare args
        args = [
            "./example/space_group_test/5gge_map.mtz",  # mapfile, using relative directory from tests/
            "./example/space_group_test/5gge.pdb",  # structurefile, using relative directory from tests/
            "-l", "FP,SIGFP",
        ]
        ...
        qfit.structure = qfit.structure.extract("resi", (60, 61), "==")
    ...
    def test_run_qfit_residue_parallel(self):
        ...
        print(len(mconformer_list))   # Expect: 2 residues ie 60 is Ser and 61 is Ala
