...
class TestQFitProtein:
    def mock_main(self):
        # Prepare args
        args = [
            "./tests/space_group_test/2apb_map.mtz",  # mapfile, using relative directory from tests/
            "./tests/space_group_test/2apb.pdb",  # structurefile, using relative directory from tests/
            "-l",
            "FWT,PHWT",
        ]
