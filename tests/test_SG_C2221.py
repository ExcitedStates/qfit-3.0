...
class TestQFitProtein:
    def mock_main(self):
        # Prepare args
        args = [
            "./example/space_group_test/1dmm_map.mtz",  # mapfile, using relative directory from tests/
            "./example/space_group_test/1dmm.pdb",  # structurefile, using relative directory from tests/
            "-l", "FP,SIGFP",
        ]
