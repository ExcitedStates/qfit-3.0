...
class PDBFile(object):
    ...
    CRYSTALLOGRAPHIC_SECTION = tuple(
        "CRYST1 ORIGX1 ORIGX2 ORIGX3 SCALE1 SCALE2 SCALE3 MTRIX1 MTRIX2 MTRIX3".split()
    )
...
class CoorRecord(Record):
    fields = (
        "record atomid atomname altloc resn chain resi icode x y z q b e charge".split()
    )
    columns = [
        (0, 6),
        (6, 11),
